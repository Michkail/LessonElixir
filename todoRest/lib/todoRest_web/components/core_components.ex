defmodule TodoRestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TodoRestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TodoRestWeb.Gettext, "errors", msg, opts)
    end
  end
